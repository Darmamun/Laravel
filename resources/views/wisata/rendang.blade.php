        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="site-heading">
                    ...
                    <h1 class="jbtext1 display-5 fw-bold">KECAMATAN RENDANG</h1>
                </div>
            </div>
        </div>
    </div>
</header>
<a href="addrendang" class="btn btn-primary btn-sm">Add</a>
    <br>
       ...
       <tbody>
           @foreach ($rendang as $data)
               <tr>
                   ...
                   <td>
                    <a href="/rendang/rendangdetail/{{ $data->id_wisata }}" class="btn btn-sm btn-success">Detail</a>
                   <a href="/rendang/editrendang/{{ $data->id_wisata }}" class="btn btn-sm btn-warning">Edit</a>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="/rendang/delete/{{ $data->id_wisata }}" class="btn btn-outline">Yes</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
