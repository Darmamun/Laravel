        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="site-heading">
                    ...
                    <h1 class="jbtext1 display-5 fw-bold">KECAMATAN MANGGIS</h1>
                </div>
            </div>
        </div>
    </div>
</header>
<a href="addmanggis" class="btn btn-primary btn-sm">Add</a>
    <br>
       ...
       <tbody>
           @foreach ($manggis as $data)
               <tr>
                   ...
                   <td>
                    <a href="/manggis/manggisdetail/{{ $data->id_wisata }}" class="btn btn-sm btn-success">Detail</a>
                   <a href="/manggis/editmanggis/{{ $data->id_wisata }}" class="btn btn-sm btn-warning">Edit</a>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="/manggis/delete/{{ $data->id_wisata }}" class="btn btn-outline">Yes</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
