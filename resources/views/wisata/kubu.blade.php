        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="site-heading">
                    ...
                    <h1 class="jbtext1 display-5 fw-bold">KECAMATAN KUBU</h1>
                </div>
            </div>
        </div>
    </div>
</header>
<a href="addkubu" class="btn btn-primary btn-sm">Add</a>
    <br>
       ...
       <tbody>
           @foreach ($kubu as $data)
               <tr>
                   ...
                   <td>
                    <a href="/kubu/kubudetail/{{ $data->id_wisata }}" class="btn btn-sm btn-success">Detail</a>
                   <a href="/kubu/editkubu/{{ $data->id_wisata }}" class="btn btn-sm btn-warning">Edit</a>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="/kubu/delete/{{ $data->id_wisata }}" class="btn btn-outline">Yes</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
